Feature: Reporter can manage activities
  ...
  Background:
    ...
    Scenario: Reporter can download Activities CSV template
      ...
      Then I should see "Project Name,Activity Name,Activity Description,Provider,Spent,Q1 Spent,Q2 Spent,Q3 Spent,Q4 Spent,Budget,Q1 Budget,Q2 Budget,Q3 Budget,Q4 Budget,Districts,Beneficiaries,Outputs / Targets,Start Date,End Date"
